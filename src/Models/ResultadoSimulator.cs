...
{
    internal static class ResultadoSimulator
    {

        internal static Resultado CriarResultadoSimulado(IList<string> palavras)
        {
        ...
        internal static Dictionary<string, float> GerarDadosMensais(float valorBase)
        {
